function Sup_REV1_ChoiceMode_RightDistractors() % MATLAB R2017a
close all;

dir_save_figure = ['D:\Arseny\S1ALM_revision_figures\'];
filename = 'Sup_REV1_ChoiceMode_RightDistractors';
...
[xl,yl]=figure_plot_behav_distractor_full_righttrials_bar3 (behav_param,behav_param_mean, behav_param_signif,  x_r, x_l, y_r, y_l, trn_r, trn_l, flag_plot_left_right_trials,plot_signif_offset, names_right_trials, names_left_trials, legends{2} );
