function Fig_Slope4() % MATLAB R2017a
close all;

mode_type_name ='Choice';
...
rel_choice_full =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageBaseline6 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime) & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0') -  ANL.ExcludeSession;
xlabel_flag=1;
ylabel_flag=1;
y_lims = [-0.15,1];
stim_legend_flag=1;
...
rel_temp =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageBaseline6 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime)  & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0') -  ANL.ExcludeSession;
