function Fig_Slope() % MATLAB R2017a
close all;
...
rel_choice_full =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageBaseline3 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime) & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
xlabel_flag=1;
ylabel_flag=1;
y_lims = [-0.1,1];
stim_legend_flag=1;
...
rel_temp =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageBaseline3 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime)  & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
...
axes('position',[position_x3(4), position_y3(1), panel_width3, panel_height3*1.25]);
outcome='hit';
key_trial_type.trial_type_name=[];
k=key;
k.training_type = 'distractor';
