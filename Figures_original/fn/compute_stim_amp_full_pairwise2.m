function [delta_spikes] = compute_stim_amp_full_pairwise2 (rel,Param, colr, flag_normalize_modes, plot_r_flag, yl, signif_display_offset, key)
...
if flag_normalize_modes==1
    mean_right=mean(delta_spikes(:,1));
