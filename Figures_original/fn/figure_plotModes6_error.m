function [xl, yl] = figure_plotModes6 (rel,Param, xlabel_flag, title1, title2,title3, ylabel_flag, key, mode_names_titles, y_lims, flag_normalize_modes, plot_r_flag, stim_icon_flag, stim_time_flag, xl, line_style)
...
[~] = fn_plotProjection_for_figure22_error(Param, rel, key, trial_type_substract, ylab,mode_names_titles{1}, flag_normalize_modes, plot_r_flag, line_style, stim_time_flag);
