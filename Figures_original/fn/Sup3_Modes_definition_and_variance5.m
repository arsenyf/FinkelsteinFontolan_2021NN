...
filename = 'Sup3_Modes_definition_and_variance5';
...
if contains(k.unit_quality, 'ok or good')
    rel_Proj_trials =(EXP.Session * EXP.SessionID * ANL.ProjTrial100 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime) & kk & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=6' & 'num_sample_selective_units>=0');
    ...
    kk = rmfield(kk,'unit_quality')
    
    rel_PSTH = (( ANL.PSTHTrial * EXP.Session * EXP.SessionID * EPHYS.Unit * EPHYS.UnitPosition * EPHYS.UnitCellType * EXP.SessionTraining  *ANL.SessionGrouping * ANL.TrialTypeGraphic ) ) & ANL.IncludeUnit2 & kk & 'unit_quality!="multi"' & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=6' & 'num_sample_selective_units>=0');
elseif contains(k.unit_quality, 'all')
    ...
    k = rmfield(k,'unit_quality')
    kk = rmfield(kk,'unit_quality')
    rel_PSTH = ((  ANL.PSTHTrial * EXP.Session * EXP.SessionID * EPHYS.Unit * EPHYS.UnitPosition * EPHYS.UnitCellType * EXP.SessionTraining  *ANL.SessionGrouping)) & ANL.IncludeUnit2 & kk & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=6' & 'num_sample_selective_units>=0');
