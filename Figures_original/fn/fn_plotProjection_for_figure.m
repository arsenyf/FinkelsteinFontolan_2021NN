...
min_num_trials_projected_error_or_ignore = 10; %Param.parameter_value{(strcmp('min_num_trials_projected_error_or_ignore',Param.parameter_name))};
...
for itype= 1:1:numel(trial_types)
    ...
    if strcmp(line_style,':')
            plot(time,POUT.p(itype,:),'Color',POUT.rgb(itype,:) ,'LineWidth',1,'LineStyle',line_style);
    else
