function [xl, yl] = figure_plotModes_correct_or_error_timeshifted2 (rel,Param, xlabel_flag, title1, title2,title3, ylabel_flag,  mode_names_titles, y_lims, outcome, flag_normalize_modes, plot_r_flag, key_trial_type, stim_legend_flag, key,  xl, line_style, stim_time_flag)
...
PROJ = fn_plotProjection_for_figure_correct_or_error_timeshifted3 (Param, rel, key_mode, trial_type_substract, ylab,mode_names_titles{1}, flag_normalize_modes, plot_r_flag, line_style, stim_time_flag, key_trial_type);
