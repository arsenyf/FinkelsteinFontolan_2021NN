...
for itype= 1:1:numel(trial_types)
    ...
    if contains(key_mode.outcome,'miss')
        if contains(POUT.trial_types{1},'-1.6')
            plot(temp_time,POUT.p(itype,:),'Color',[0.5 0.5 0.75] ,'LineWidth',0.5,'LineStyle',line_style);
            
        else
            plot(temp_time,POUT.p(itype,:),'Color',POUT.rgb(itype,:) ,'LineWidth',0.5,'LineStyle',line_style);
        end
    else
        plot(temp_time,POUT.p(itype,:),'Color',POUT.rgb(itype,:) ,'LineWidth',0.5,'LineStyle',line_style);
    end
