function [xl, yl] = figure_plotModes_correct_or_error_double_distractor (rel,Param, xlabel_flag, title1, title2,title3, ylabel_flag,  mode_names_titles, y_lims, outcome, flag_normalize_modes, plot_r_flag, key_trial_type, stim_legend_flag, key,  xl, line_style, stim_time_flag)
...
PROJ = fn_plotProjection_for_figure_correct_or_error5 (Param, rel, key_mode, trial_type_substract, ylab,mode_names_titles{1}, flag_normalize_modes, plot_r_flag, line_style, stim_time_flag, key_trial_type, key);
...
%     set(gca,'Xtick',[-2.5 -1.6 -0.8 0],'TickDir','out','FontSize',6);
    set(gca,'Xtick',[-4 -2  0],'TickDir','out','FontSize',6);
...
if stim_legend_flag==1
    ...
    elseif isfield(key,'trialtype_flag_full')
        factor=diff(yl)/6;
