function Sup_REV1_Modes_definition_and_variance_single_trials__FS()
close all;
...
if contains(k.unit_quality, 'ok or good')
    rel_Proj =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageBaseline11FS * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime) & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
...
for i_m = 1:1:numel(mode_names)
        ...
        rel_variance = ANL.ProjVariance11FS*EXP.SessionTraining *ANL.SessionGrouping & key & k_proj &  (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
