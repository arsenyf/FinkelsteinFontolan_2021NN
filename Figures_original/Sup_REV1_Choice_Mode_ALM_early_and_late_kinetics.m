function Sup_REV1_Choice_Mode_ALM_early_and_late_kinetics() % MATLAB R2017a
close all;

mode_type_name ='ChoiceMatched';

dir_save_figure = ['D:\Arseny\S1ALM_revision_figures\'];
filename = 'Sup_REV1_Choice_Mode_ALM_early_and_late_kinetics';
...
yl = [-0.2 0.2];
ylim(yl);
set(gca,'FontSize',7,'Ytick',[-0.2 0 0.2], 'Xtick',[0 xl(2)], 'XtickLabel',[0 0.8]);
...
axes('position',[position_x2(4)*1.05, position_y2(1), panel_width2, panel_height2]);
hold on;
flag_normalize_modes=1;
% Regular mini
