function Fig4_low_vs_high_ramping_together() % MATLAB R2017a
close all;
tic
...
% rel_Switch = (ANL.SwitchProbabilityHighvsLow11LateDelay * EXP.SessionID * EXP.SessionTraining *ANL.SessionGrouping *  ANL.IncludeSession - ANL.ExcludeSession ) & k & (EXP.SessionTask &'task="s1 stim"');
rel_Switch = (ANL.SwitchProbabilityHighvsLow11LateDelay* EXP.SessionID * EXP.SessionTraining *ANL.SessionGrouping) & k & (EXP.SessionTask &'task="s1 stim"') & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
