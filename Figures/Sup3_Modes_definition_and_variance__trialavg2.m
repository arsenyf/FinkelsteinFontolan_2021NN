function Sup3_Modes_definition_and_variance__trialavg2()
close all;
...
filename = 'Sup3_Modes_definition_and_variance_trial_average';
...
position_x1(7)=position_x1(6)+horizontal_distance1*0.7;
...
if contains(k.unit_quality, 'ok or good')
    ...
    rel_ProjDA =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageDA11 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime) & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
    k = rmfield(k,'unit_quality');
    rel_PSTH = (( ANL.PSTHDAAverage * EXP.Session * EXP.SessionID * EPHYS.Unit * EPHYS.UnitPosition * EPHYS.UnitCellType * EXP.SessionTraining  *ANL.SessionGrouping * ANL.TrialTypeGraphic ) ) & ANL.IncludeUnit2 & k & 'unit_quality!="multi"' & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
elseif contains(k.unit_quality, 'all')
    rel_Proj =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageBaseline11 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime) & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
    rel_ProjDA =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageDA11 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime) & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
    k = rmfield(k,'unit_quality');
    rel_PSTH = (( ANL.PSTHDAAverage * EXP.Session * EXP.SessionID * EPHYS.Unit * EPHYS.UnitPosition * EPHYS.UnitCellType * EXP.SessionTraining  *ANL.SessionGrouping)) & ANL.IncludeUnit2 & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
...
[trialavg_var_explained, time2plot]= fn_compute_varaince2(Param,rel_ProjDA,rel_PSTH, mode_names);


%'Trial-averaged Variance explained
axes('position',[position_x2(4), position_y1(3), panel_width2, panel_height1]);
xl=fn_plot_variance(Param, time2plot, trialavg_var_explained, colr);
yl=[0 0.7];
ylim(yl);
set(gca, 'Ytick',[0 0.7]);
