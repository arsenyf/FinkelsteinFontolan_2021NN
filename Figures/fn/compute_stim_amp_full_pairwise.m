function [delta_spikes] = compute_stim_amp_full_pairwise (rel,Param, colr, flag_normalize_modes, plot_r_flag, yl, signif_display_offset, key)
...
if flag_normalize_modes==1
    ...
    delta_spikes(:,i_types)=delta_spikes(:,i_types)./delta_spikes_right;
    end
