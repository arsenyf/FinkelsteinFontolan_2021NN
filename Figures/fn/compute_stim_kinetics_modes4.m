...
smooth_time = Param.parameter_value{(strcmp('smooth_time_proj_choice_mini_kinetics',Param.parameter_name))};
...
Max_Right_Global = nanmax(Proj_Right_global_avg(time>-3.5 & time<=0));
Min_Left_Global = nanmin(Proj_Baseline_global_avg(time>-3.5 & time<=0));
