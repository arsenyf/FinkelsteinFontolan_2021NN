function [xl, yl] = figure_plotModes_double_distractors (rel,Param, xlabel_flag, title1, title2,title3, ylabel_flag, key, mode_names_titles, y_lims, flag_normalize_modes, plot_r_flag, stim_legend_flag, xl, line_style, stim_time_flag)
...
[~] = fn_plotProjection_for_figure2_double_distractors(Param, rel, key, trial_type_substract, ylab,mode_names_titles{1}, flag_normalize_modes, plot_r_flag, line_style, stim_time_flag);
