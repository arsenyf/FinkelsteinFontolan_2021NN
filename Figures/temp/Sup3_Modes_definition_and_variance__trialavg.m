function Sup3_Modes_definition_and_variance__trialavg()
close all;
...
colr{1}=[ [0.5,0.5,0.5]];
colr{2}=[[0,0.500000000000000,0.500000000000000]];
...
if contains(k.unit_quality, 'ok or good')
    ...
    rel_PSTH = (( ANL.PSTHAverage * EXP.Session * EXP.SessionID * EPHYS.Unit * EPHYS.UnitPosition * EPHYS.UnitCellType * EXP.SessionTraining  *ANL.SessionGrouping * ANL.TrialTypeGraphic ) ) & ANL.IncludeUnit2 & k & 'unit_quality!="multi"' & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
elseif contains(k.unit_quality, 'all')
rel_Proj =(EXP.Session * EXP.SessionID * ANL.ProjTrialAverageBaseline11 * EXP.SessionTraining  * ANL.TrialTypeID * ANL.TrialTypeGraphic * ANL.TrialTypeInstruction * ANL.SessionGrouping * ANL.TrialTypeStimTime) & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
        k = rmfield(k,'unit_quality')
        rel_PSTH = (( ANL.PSTHAverage * EXP.Session * EXP.SessionID * EPHYS.Unit * EPHYS.UnitPosition * EPHYS.UnitCellType * EXP.SessionTraining  *ANL.SessionGrouping)) & ANL.IncludeUnit2 & k & (ANL.IncludeSessionSelectivity2 & 'num_delay_selective_units>=0' & 'num_sample_selective_units>=0');
